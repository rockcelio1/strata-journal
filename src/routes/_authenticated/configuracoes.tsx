...
const subNav = [
  ...
  { to: "/configuracoes/onedrive", label: "OneDrive (Diagnóstico)", icon: Cloud, desc: "Conta, pasta de destino e validação" },
  { to: "/configuracoes/integracoes/onedrive-admin", label: "OneDrive (Admin)", icon: Cloud, desc: "Configurações globais e Azure AD" },
